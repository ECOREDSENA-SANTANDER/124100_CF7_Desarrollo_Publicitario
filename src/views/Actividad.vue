  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conceptos del plan de comunicación
        p.mb-4 #[b  El objetivo de la actividad es que el aprendiz afiance conocimientos acerca del #[em endomarketing] y la comunicación hacia el interior.] 
